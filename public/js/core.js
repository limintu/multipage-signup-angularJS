...
// form controller
app.controller('formController', function($scope, previewService, $state) {
  $scope.options = [
    ...
    'Curling','Cycling','Darts','Decathlon','Down Hill Skiing','Equestrianism',
    'eSports','Fencing','Field Hockey','Figure Skating','Gymnastics','Ice Hockey',
    'Martial Arts','Mixed Martial Arts','Modern Pentathlon','Motorcycle Racing',
    'Netball','Polo','Racquetball','Rowing','Rugby','Sailing','Softball','Shooting',
    'Skateboarding','Skeet Shooting','Skeleton','Snow Boarding','Soccer (Football)',
    'Squash','Surfing','Swimming','Track and Field'
  ];
  ...
  $scope.goToAbout = function() {
    // console.log("name: " + $scope.user.name!=undefined);

    if ($scope.user.name!=undefined && $scope.user.dob!=undefined
      && $scope.user.nationality!=undefined && $scope.user.gender!=undefined) {
        // console.log(true);
        $state.go("form.about");
      }
  };

  $scope.goToSocialMedia = function() {
    if ($scope.user.location!=undefined && $scope.user.association!=undefined
       && $scope.user.sports!=undefined) {
      $state.go("form.socialMedia");
    }
  };
